  ...
  <div class="border-b border-gray-200/80 py-2.5 last:border-b-0">
    ...
    <div v-if="value === 'Si'" class="mt-2">
      <input
        ...
        type="text"
        class="w-full px-2.5 py-1.5 text-sm border border-gray-300 rounded-md text-gray-700 placeholder-gray-400 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-200"
