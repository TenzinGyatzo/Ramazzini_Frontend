...
// Watch para establecer 'Negado' cuando cardiopaticos sea 'No' y enfocar input cuando sea 'Si'
watch(cardiopaticos, async (newValue) => {
    if (newValue === 'No') {
        formDataHistoriaClinica.cardiopaticosEspecificar = 'Negado';
    }
    if (newValue === 'Si') {
...
<template>
    <div>
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                >
                    ...
                    <div 
                        :class="[
                            ...
                            cardiopaticos === 'No' ? 'bg-emerald-600 text-white' : 'bg-gray-200 text-gray-600'
                        ]"
                    >
                ...
                >
                    ...
                    <div 
                        :class="[
                            'w-8 h-8 rounded-full flex items-center justify-center mb-1.5 transition-colors duration-200',
                            cardiopaticos === 'Si' ? 'bg-emerald-600 text-white' : 'bg-gray-200 text-gray-600'
                        ]"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        >
            <div v-if="cardiopaticos === 'Si'" class="mt-6">
