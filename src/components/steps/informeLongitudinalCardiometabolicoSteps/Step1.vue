...
function snapshotEvento(ev) {
  return {
    idEventoOriginal: ev._id,
    fechaControl: toYyyyMmDd(ev.fechaEventoSeguimientoCardiometabolico) || undefined,
...
function sincronizarPayloadInforme() {
  ...
  fd.numeroSeguimientosProgramados = segSel.length;
          ...
          >
            <label class="flex items-start gap-2 cursor-pointer">
              ...
              <span class="flex-1">
                ...
                <span class="text-gray-600"> — {{ ev.motivoSeguimiento || 'Sin motivo' }}</span>
              </span>
            </label>
          </li>
        </ul>
            ...
            <label class="flex items-start gap-2 cursor-pointer">
              ...
              <span class="flex-1">
                ...
                <span class="text-gray-600">
                  — {{ s.motivo || '—' }}{{ s.estado ? ` · ${s.estado}` : '' }}</span
                >
              </span>
            </label>
          </li>
