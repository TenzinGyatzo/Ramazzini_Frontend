    ...
    <div>
        <template v-if="variant === 'compact'">
            <AntecedenteSiNoChips
                label="PSIQUIÁTRICOS"
                question="¿Antecedentes de trastornos psiquiátricos en la familia?"
                v-model="psiquiatricos"
                v-model:especificar="formDataHistoriaClinica.psiquiatricosEspecificar"
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                >
                    <input type="radio" value="No" v-model="psiquiatricos" class="sr-only" />
                    <div 
                        :class="[
                    ...
                    >No</span>
                    <div v-if="psiquiatricos === 'No'" class="absolute top-2 right-2 w-4 h-4 bg-emerald-600 rounded-full flex items-center justify-center">
                ...
                >
                    <input type="radio" value="Si" v-model="psiquiatricos" class="sr-only" />
                    <div 
                        :class="[
                            'w-8 h-8 rounded-full flex items-center justify-center mb-1.5 transition-colors duration-200',
                    ...
                    >Sí</span>
                    <div v-if="psiquiatricos === 'Si'" class="absolute top-2 right-2 w-4 h-4 bg-emerald-600 rounded-full flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-2.5 w-2.5 text-white" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                        </svg>
                    </div>
