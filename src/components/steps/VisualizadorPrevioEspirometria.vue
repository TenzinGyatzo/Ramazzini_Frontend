...
const { edad, antiguedad } = useEdadAntiguedadDocumento(() => formData.formDataPrevioEspirometria.fechaPrevioEspirometria);
...
<template>
  <div
      ...
      <div class="flex flex-wrap gap-2">
        ...
        <div class="w-full md:w-[calc(50%-0.25rem)]">
          ...
          <div class="mb-4" :class="sectionOutlineClass('factoresRiesgo')">
            <h2 class="text-lg font-medium mb-1 text-center cursor-pointer" :data-paso="resolveNavStep(2)" @click="goToSectionOnly(2)">FACTORES DE RIESGO RESPIRATORIO</h2>
            <table class="table-auto w-full border-collapse border border-gray-200">
              <thead>
              ...
              <tbody>
                ...
                <tr class="odd:bg-white even:bg-gray-50 cursor-pointer" :class="[rowOutlineClass(2), rowPinpointClass(2)]" :data-paso="resolveNavStep(2)" @click="goToStep(2)" style="height: 1.75rem;">
          ...
          <div class="mb-4" :class="sectionOutlineClass('antecedentes')">
            <h2 class="text-lg font-medium mb-1 text-center cursor-pointer" :data-paso="resolveNavStep(13)" @click="goToSectionOnly(13)">ANTECEDENTES MÉDICOS RELEVANTES</h2>
            <table class="table-auto w-full border-collapse border border-gray-200">
              <thead>
                <tr class="bg-gray-200">
                  <th class="w-3/4 text-xs sm:text-sm text-center px-2 py-0 border border-gray-300">-</th>
              ...
              <tbody>
                <tr class="odd:bg-white even:bg-gray-50 cursor-pointer" :data-paso="resolveNavStep(13)" @click="goToStep(13)" style="height: 1.75rem;"
                ...
                <tr class="odd:bg-white even:bg-gray-50 cursor-pointer" :data-paso="resolveNavStep(14)" @click="goToStep(14)" style="height: 1.75rem;"
                ...
                <tr class="odd:bg-white even:bg-gray-50 cursor-pointer" :data-paso="resolveNavStep(15)" @click="goToStep(15)" style="height: 1.75rem;"
                ...
                <tr class="odd:bg-white even:bg-gray-50 cursor-pointer" :data-paso="resolveNavStep(16)" @click="goToStep(16)" style="height: 1.75rem;"
          ...
          <div class="mb-4" :class="sectionOutlineClass('contraindRelativas')">
            <h2 class="text-lg font-medium mb-1 text-center cursor-pointer" :data-paso="resolveNavStep(18)" @click="goToSectionOnly(18)">CONTRAINDICACIONES RELATIVAS</h2>
            <table class="table-auto w-full border-collapse border border-gray-200">
              <thead>
                <tr class="bg-gray-200">
                  <th class="w-3/4 text-xs sm:text-sm text-center px-2 py-0 border border-gray-300">-</th>
              ...
              <tbody>
                <tr class="odd:bg-white even:bg-gray-50 cursor-pointer" :data-paso="resolveNavStep(18)" @click="goToStep(18)" style="height: 1.75rem;"
                ...
                <tr class="odd:bg-white even:bg-gray-50 cursor-pointer" :data-paso="resolveNavStep(19)" @click="goToStep(19)" style="height: 1.75rem;"
                ...
                <tr class="odd:bg-white even:bg-gray-50 cursor-pointer" :data-paso="resolveNavStep(20)" @click="goToStep(20)" style="height: 1.75rem;"
                ...
                <tr class="odd:bg-white even:bg-gray-50 cursor-pointer" :data-paso="resolveNavStep(21)" @click="goToStep(21)" style="height: 1.75rem;"
                ...
                <tr class="odd:bg-white even:bg-gray-50 cursor-pointer" :data-paso="resolveNavStep(22)" @click="goToStep(22)" style="height: 1.75rem;"
        ...
        <div class="w-full md:w-[calc(50%-0.25rem)]">
          ...
          <div class="mb-4" :class="sectionOutlineClass('sintomas')">
            <h2 class="text-lg font-medium mb-1 text-center cursor-pointer" :data-paso="resolveNavStep(7)" @click="goToSectionOnly(7)">SÍNTOMAS RESPIRATORIOS</h2>
            <table class="table-auto w-full border-collapse border border-gray-200">
              <thead>
                <tr class="bg-gray-200">
                  <th class="w-3/4 text-xs sm:text-sm text-center px-2 py-0 border border-gray-300">-</th>
              ...
              <tbody>
                ...
                <tr class="odd:bg-white even:bg-gray-50 cursor-pointer" :data-paso="resolveNavStep(8)" @click="goToStep(8)" style="height: 1.75rem;"
                ...
                <tr class="odd:bg-white even:bg-gray-50 cursor-pointer" :data-paso="resolveNavStep(9)" @click="goToStep(9)" style="height: 1.75rem;"
                ...
                <tr class="odd:bg-white even:bg-gray-50 cursor-pointer" :data-paso="resolveNavStep(10)" @click="goToStep(10)" style="height: 1.75rem;"
                ...
                <tr class="odd:bg-white even:bg-gray-50 cursor-pointer" :data-paso="resolveNavStep(11)" @click="goToStep(11)" style="height: 1.75rem;"
                ...
                <tr class="odd:bg-white even:bg-gray-50 cursor-pointer" :data-paso="resolveNavStep(12)" @click="goToStep(12)" style="height: 1.75rem;"
          ...
          :class="[sectionOutlineClass('antecedentes'), rowOutlineClass(17), rowPinpointClass(17)]">
            <h2 class="text-lg font-medium mb-1 text-center cursor-pointer" :data-paso="resolveNavStep(17)" @click="goToSectionOnly(17)">MEDICAMENTOS ACTUALES</h2>
            <table class="table-auto w-full border-collapse border border-gray-200">
              <thead>
                <tr class="bg-gray-200">
                  <th class="w-3/4 text-xs sm:text-sm text-center px-2 py-0 border border-gray-300">-</th>
              ...
              <tbody>
                <tr class="odd:bg-white even:bg-gray-50 cursor-pointer" :class="[rowOutlineClass(17), rowPinpointClass(17)]" :data-paso="resolveNavStep(17)" @click="goToStep(17)" style="height: 1.75rem;">
                ...
                <tr class="odd:bg-white even:bg-gray-50 cursor-pointer" :class="[rowOutlineClass(17), rowPinpointClass(17)]" :data-paso="resolveNavStep(17)" @click="goToStep(17)" style="height: 5.25rem;">
          ...
          <div class="mb-4" :class="sectionOutlineClass('contraindAbsolutas')">
            <h2 class="text-lg font-medium mb-1 text-center cursor-pointer" :data-paso="resolveNavStep(23)" @click="goToSectionOnly(23)">CONTRAINDICACIONES ABSOLUTAS</h2>
            <table class="table-auto w-full border-collapse border border-gray-200">
              <thead>
                <tr class="bg-gray-200">
                  <th class="w-3/4 text-xs sm:text-sm text-center px-2 py-0 border border-gray-300">-</th>
              ...
              <tbody>
                <tr class="odd:bg-white even:bg-gray-50 cursor-pointer" :data-paso="resolveNavStep(23)" @click="goToStep(23)" style="height: 1.75rem;"
                ...
                <tr class="odd:bg-white even:bg-gray-50 cursor-pointer" :data-paso="resolveNavStep(27)" @click="goToStep(27)" style="height: 1.75rem;"
    ...
    <div class="w-full" :class="[sectionOutlineClass('resultado'), rowOutlineClass(28), rowPinpointClass(28)]">
      <h2 class="text-lg font-medium mb-1 text-center cursor-pointer" :data-paso="resolveNavStep(28)" @click="goToSectionOnly(28)">RESULTADO DEL CUESTIONARIO</h2>
      <table class="table-auto w-full border-collapse border border-gray-200">
        <tbody>
          <!-- Encabezado -->
          <tr class="bg-gray-200 cursor-pointer" :class="[rowOutlineClass(28), rowPinpointClass(28)]" :data-paso="resolveNavStep(28)" @click="goToStep(28)">
            <td class="w-1/2 text-xs sm:text-sm px-2 py-0 border border-gray-300 font-light text-center">
              ESPIROMETRÍA
            </td>
          </tr>
          <!-- Fila combinada -->
          <tr class="bg-white cursor-pointer" :class="[rowOutlineClass(28), rowPinpointClass(28)]" :data-paso="resolveNavStep(28)" @click="goToStep(28)">
