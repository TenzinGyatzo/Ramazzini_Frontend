...
<template>
  <div>
    ...
    <h2 :class="isCompact ? 'text-sm font-semibold mb-2 text-gray-800' : 'mb-2'">TRABAJO ANTERIOR 3</h2>
    ...
    <div :class="fieldClass">
      ...
      <input
        type="text"
        :class="inputClass"
        v-model="formDataHistoriaClinica.empresaAnterior3"
    ...
    <div :class="fieldClass">
      ...
      <input
        type="text"
        :class="inputClass"
        v-model="formDataHistoriaClinica.puestoAnterior3"
    ...
    <div :class="fieldClass">
      ...
      <input
        type="text"
        :class="inputClass"
        v-model="formDataHistoriaClinica.antiguedadAnterior3"
