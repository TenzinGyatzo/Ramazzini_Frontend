    ...
    onMounted(() => {
      ...
      if (documentos.currentTypeOfDocument === 'antidoping') {
        ...
        stepsStore.setSteps([
          ...
          { component: Step7EventoSeguimientoCardiometabolico, name: 'Estado por condición' },
        ...
        stepsStore.setSteps([
          ...
          { component: Step2InformeLongitudinalCardiometabolico, name: 'Interpretación' },
        ]);
      } else {
