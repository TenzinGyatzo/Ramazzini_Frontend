...
import Step4InformeLongitudinalAudiometrico from '../steps/informeLongitudinalAudiometricoSteps/Step4.vue';
    ...
    onMounted(() => {
      ...
      if (documentos.currentTypeOfDocument === 'antidoping') {
        ...
        stepsStore.setSteps([
          ...
          { component: Step4InformeLongitudinalAudiometrico, name: 'Recomendaciones' },
        ]);
      } else {
