  ...
  <div
    ...
    <div class="flex flex-wrap md:flex-nowrap w-full gap-4 items-center">
      <EstadoDocumentoBadgeAlt 
        v-if="isMX"
        :estado="formData.formDataCertificadoExpedito.estado" 
        :fechaFinalizacion="formData.formDataCertificadoExpedito.fechaFinalizacion" 
        :finalizadoPor="formData.formDataCertificadoExpedito.finalizadoPor"
        :fechaAnulacion="formData.formDataCertificadoExpedito.fechaAnulacion"
        :anuladoPor="formData.formDataCertificadoExpedito.anuladoPor"
        :razonAnulacion="formData.formDataCertificadoExpedito.razonAnulacion"
