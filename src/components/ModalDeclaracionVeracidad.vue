...
<template>
  <div class="modal fixed top-0 left-0 z-10 p-8 h-screen w-full grid place-items-center">
    ...
    <Transition appear name="fade">
      <div
        class="modal-inner relative bg-white text-gray-900 w-full max-w-md p-8 rounded-lg shadow-md shadow-slate-900 max-h-[90vh] overflow-y-auto"
      >
        <div
        ...
        <h1 class="text-2xl mb-2 pr-8">Declaración de Veracidad</h1>
        ...
        <div class="space-y-4">
          <div>
            <label for="fecha-declaracion" class="block text-sm font-semibold text-gray-700 mb-2">
            ...
            <input
              ...
              class="w-full border border-gray-300 rounded-lg px-4 py-2 text-gray-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 disabled:opacity-60"
            />
          </div>

          <div class="rounded-lg bg-gray-50 border border-gray-200 px-4 py-3 text-sm text-gray-600">
            <span class="font-semibold text-gray-700">Trabajador:</span>
            {{ nombreTrabajador || '—' }}
          </div>
        </div>
        ...
        <div class="mt-8 space-y-3">
          ...
          <button
            type="button"
            class="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-3 px-6 rounded-lg transition-all duration-300 disabled:opacity-60"
            :disabled="descargando"
            @click="closeModal"
          >
            Cerrar
